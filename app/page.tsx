      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-100 pt-20 pb-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-bold text-[#0B1120] mb-8 leading-tight">
              Ihre Forderung.
              <br />
              <span className="text-[#0050FF]">Unsere Mission.</span>
          </h1>
        ...
        <div className="mt-24 border-t border-slate-200 pt-12">
          ...
          <div className="max-w-6xl mx-auto px-4 flex flex-wrap justify-center items-center gap-12 opacity-60 grayscale">
            <div className="text-2xl font-bold text-slate-700">BDIU</div>
            <div className="text-2xl font-bold text-slate-700">SCHUFA</div>
            <div className="text-2xl font-bold text-slate-700">Wolters Kluwer</div>
            <div className="text-2xl font-bold text-slate-700">GeoTrust</div>
            <div className="text-2xl font-bold text-slate-700">GDD</div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="text-center group">
              <div className="w-20 h-20 bg-gradient-to-br from-[#0050FF] to-[#0040CC] rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg">
                <Upload className="w-10 h-10 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-[#0B1120] mb-4">
                Fall einreichen
              </h3>
          ...
          <div className="text-center mt-16">
            <Link
              href="/einreichen"
              className="inline-flex items-center gap-2 bg-[#0050FF] text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-[#0040CC] hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-300"
            >
      ...
      <section className="py-24 bg-gradient-to-br from-slate-50 to-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative max-w-4xl mx-auto">
            {/* Timeline Line */}
            <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#0050FF] to-slate-300 transform -translate-x-1/2" />
            ...
            <div className="space-y-16">
              ...
              <div className="relative flex items-center">
                <div className="md:w-1/2 md:pr-12 text-right">
                  <h3 className="text-2xl font-bold text-[#0B1120] mb-3">
                ...
                <div className="hidden md:flex absolute left-1/2 transform -translate-x-1/2 w-12 h-12 bg-[#0050FF] rounded-full items-center justify-center border-4 border-white shadow-lg">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-700 max-w-3xl mx-auto font-semibold">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Kachel 1 */}
            <div className="group bg-gradient-to-br from-slate-50 to-white border border-slate-200 rounded-2xl p-8 hover:shadow-2xl hover:scale-105 transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-br from-[#0050FF] to-[#0040CC] rounded-xl flex items-center justify-center mb-6 group-hover:rotate-6 transition-transform duration-300">
