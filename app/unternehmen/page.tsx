      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-100 pt-20 pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-6xl font-bold text-primary mb-8 leading-tight text-center">
              Über <span className="text-signal">Nota Finance</span>
            </h1>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-signal via-signal to-muted transform -translate-x-1/2" />
            ...
            <div className="space-y-16">
              ...
              <div className="relative">
                <div className="md:flex md:items-center">
                  <div className="md:w-1/2 md:pr-12 md:text-right">
                    <div className="inline-block bg-gradient-to-br from-signal to-signal/70 text-white px-6 py-2 rounded-full font-bold text-xl mb-4">
                      2008
                    </div>
                  ...
                  <div className="hidden md:flex absolute left-1/2 transform -translate-x-1/2 w-6 h-6 bg-signal rounded-full border-4 border-white shadow-lg" />
              ...
              <div className="relative">
                <div className="md:flex md:items-center">
                  <div className="md:w-1/2" />
                  <div className="hidden md:flex absolute left-1/2 transform -translate-x-1/2 w-8 h-8 bg-gradient-to-br from-signal to-signal/70 rounded-full border-4 border-white shadow-2xl animate-pulse" />
                  <div className="md:w-1/2 md:pl-12">
                    <div className="inline-block bg-gradient-to-br from-signal to-signal/70 text-white px-6 py-2 rounded-full font-bold text-xl mb-4">
                      2025
                    </div>
                    <h3 className="text-2xl font-bold text-signal mb-3">
                      Launch von Nota Finance
                    </h3>
                    <p className="text-primary/70 leading-relaxed font-semibold">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Wert 1 */}
            <div className="group bg-gradient-to-br from-slate-50 to-white border-2 border-muted rounded-2xl p-8 hover:shadow-2xl hover:scale-105 hover:border-signal transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-br from-signal to-signal/70 rounded-2xl flex items-center justify-center mb-6 group-hover:rotate-6 transition-transform duration-300">
