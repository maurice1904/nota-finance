...
import { CheckCircle, Users, Shield, Zap, Clock, ChevronDown, AlertCircle, Check } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <RevealOnScroll delay={0}>
              <div className="group bg-gradient-to-br from-white to-surface-100/50 border border-border-subtle rounded-2xl p-6 sm:p-8 hover:shadow-xl hover:border-brand-700/30 transition-all duration-300 h-full">
            ...
            <RevealOnScroll delay={200}>
              <div className="group bg-gradient-to-br from-white to-surface-100/50 border border-border-subtle rounded-2xl p-6 sm:p-8 hover:shadow-xl hover:border-brand-700/30 transition-all duration-300 md:col-span-2 md:max-w-md md:mx-auto lg:col-span-1 lg:max-w-none h-full">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6 lg:gap-8 mt-6 lg:mt-8">
            ...
            <RevealOnScroll delay={300}>
              <div className="group bg-gradient-to-br from-white to-surface-100/50 border border-border-subtle rounded-2xl p-6 sm:p-8 hover:shadow-xl hover:border-brand-700/30 transition-all duration-300 md:w-full h-full">
