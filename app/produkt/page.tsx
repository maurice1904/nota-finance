        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-primary mb-8 leading-tight">
              ...
              <span className="text-signal">Einfach. Effektiv. Fair.</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg mb-8 hover:shadow-2xl transition-shadow duration-300">
            <div className="flex items-start gap-6">
              <div className="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-signal to-signal/70 rounded-2xl flex items-center justify-center">
              ...
              <div className="flex-1">
                ...
                <div className="space-y-4 text-primary/70">
                  <div>
                    <h4 className="font-bold text-lg text-primary mb-2">Einfach & Unkompliziert:</h4>
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-primary mb-2">Ohne Registrierungszwang:</h4>
                    <p className="leading-relaxed">
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-primary mb-2">Automatische Prüfung & Bestätigung:</h4>
                    <p className="leading-relaxed">
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-4 text-primary/70">
                    <div>
                      <h5 className="font-bold text-lg text-primary mb-2">Professionelle Kommunikation:</h5>
                      <p className="leading-relaxed">
                    ...
                    <div>
                      <h5 className="font-bold text-lg text-primary mb-2">Individuelle Strategie:</h5>
                      <p className="leading-relaxed">
                    ...
                    <div>
                      <h5 className="font-bold text-lg text-primary mb-2">Keine Kosten für Sie:</h5>
                      <p className="leading-relaxed">
                ...
                <div>
                  ...
                  <div className="space-y-4 text-primary/70">
                    <div>
                      <h5 className="font-bold text-lg text-primary mb-2">Nur nach Rücksprache:</h5>
                      <p className="leading-relaxed">
                    ...
                    <div>
                      <h5 className="font-bold text-lg text-primary mb-2">Transparente Kosten:</h5>
                      <p className="leading-relaxed">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg hover:shadow-2xl transition-shadow duration-300">
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="space-y-4 text-primary/70">
                  <div>
                    <h4 className="font-bold text-lg text-primary mb-2">100% für Sie:</h4>
                    <p className="leading-relaxed">
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-primary mb-2">Schnelle Abwicklung:</h4>
                    <p className="leading-relaxed">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Vorteil 1 */}
            <div className="bg-gradient-to-br from-slate-50 to-white border border-muted rounded-2xl p-8 hover:shadow-xl hover:scale-105 transition-all duration-300">
              <Zap className="w-12 h-12 text-signal mb-4" />
              <h3 className="text-2xl font-bold text-primary mb-4">Maximale Einfachheit</h3>
            ...
            {/* Vorteil 2 */}
            <div className="bg-gradient-to-br from-slate-50 to-white border border-muted rounded-2xl p-8 hover:shadow-xl hover:scale-105 transition-all duration-300">
              <Clock className="w-12 h-12 text-signal mb-4" />
              <h3 className="text-2xl font-bold text-primary mb-4">Digitale Effizienz</h3>
              <ul className="space-y-2 text-primary/70">
            ...
            {/* Vorteil 3 */}
            <div className="bg-gradient-to-br from-slate-50 to-white border border-muted rounded-2xl p-8 hover:shadow-xl hover:scale-105 transition-all duration-300">
              <Users className="w-12 h-12 text-signal mb-4" />
              <h3 className="text-2xl font-bold text-primary mb-4">Absolute Kundenorientierung</h3>
              <ul className="space-y-2 text-primary/70">
            ...
            <div className="bg-gradient-to-br from-slate-50 to-white border border-muted rounded-2xl p-8 hover:shadow-xl hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-primary mb-4">Volle Kostentransparenz & Fairness</h3>
              <ul className="space-y-2 text-primary/70">
            ...
            {/* Vorteil 5 */}
            <div className="bg-gradient-to-br from-slate-50 to-white border border-muted rounded-2xl p-8 hover:shadow-xl hover:scale-105 transition-all duration-300 md:col-span-2 lg:col-span-1">
              <Shield className="w-12 h-12 text-signal mb-4" />
              <h3 className="text-2xl font-bold text-primary mb-4">Zuverlässigkeit & Sicherheit</h3>
              <ul className="space-y-2 text-primary/70">
